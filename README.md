[![SharpDeck verion on NuGet.org](https://img.shields.io/nuget/v/SharpDeck.svg)](https://www.nuget.org/packages/SharpDeck/) ![Build status](https://github.com/geekyeggo/sharpdeck/workflows/build/badge.svg)
