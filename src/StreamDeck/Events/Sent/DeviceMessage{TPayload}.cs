namespace StreamDeck.Events.Sent
{
    ...
    public class DeviceMessage<TPayload> : ContextMessage<TPayload>
    {
        ...
        public DeviceMessage(string @event, string context, string device, TPayload payload)
            : base(@event, context, payload) => this.Device = device;

        /// <summary>
        /// Gets the opaque value identifying the device. Note that this opaque value will change each time you relaunch the Stream Deck application.
        /// </summary>
